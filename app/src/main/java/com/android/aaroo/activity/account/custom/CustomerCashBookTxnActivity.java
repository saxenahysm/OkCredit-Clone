...
public class CustomerCashBookTxnActivity extends AppCompatActivity {
    public static final String TAG = CustomerCashBookTxnActivity.class.getSimpleName();

    RecyclerView rv_customer;
    CustomerCashbookTxnListAdapter adapter;
    public ArrayList<CustomerCashbookTxnModel> txnArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_cash_book);
        ...
        rv_customer = findViewById(R.id.rv_txn);
        ...
        rv_customer.setLayoutManager(linearLayoutManager);
       ...
       //  SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        ...
        adapter = new CustomerCashbookTxnListAdapter(txnArrayList, CustomerCashBookTxnActivity.this);
        rv_customer.setAdapter(adapter);
    }

    private void getAllTransaction() {

        AndroidNetworking.get(APIs.CUSTOM_CASHBOOK_API)
                        ...
                        try {
                            ...
                            if (response.get("success").equals(true)) {
                                ...
                                for (int i = 0; i < jsonArrayData.length(); i++) {
                                    ...
                                    CustomerCashbookTxnModel model = new CustomerCashbookTxnModel();
