...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> implements Filterable {
    ...
    public ContactAdapter(AddSupplier addSupplier,Context context, ArrayList<ContactModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.ll_parent.setOnClickListener(v -> {
            addSupplier.getContactData(contactModel.getName(),contactModel.getNumber());
        });
